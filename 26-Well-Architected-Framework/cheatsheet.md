...
- **Well-Architected Tool**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **Trusted Advisor**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
