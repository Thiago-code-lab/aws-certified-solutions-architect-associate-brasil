...
Montar um fluxo minimo funcional que demonstre **Migracao de cargas e transferencia de dados**, com validacao clara de comportamento e custo controlado para ambiente de estudo.

## Servicos usados

DMS, Application Migration Service, DataSync, Snowball.
