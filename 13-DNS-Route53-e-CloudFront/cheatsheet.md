...
- **Route 53**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **CloudFront**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
