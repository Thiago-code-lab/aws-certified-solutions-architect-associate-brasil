...
Montar um fluxo minimo funcional que demonstre **Selecao de compute e disponibilidade com EC2**, com validacao clara de comportamento e custo controlado para ambiente de estudo.

## Servicos usados

EC2, Auto Scaling, ELB, EBS.
