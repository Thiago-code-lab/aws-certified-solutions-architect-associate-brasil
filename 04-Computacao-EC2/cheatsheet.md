...
- **EC2**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **Auto Scaling**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
