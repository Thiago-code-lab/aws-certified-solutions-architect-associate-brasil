...
A) Aplicar solucao generica sem considerar RDS.
B) Usar RDS com configuracao orientada ao requisito e operacao enxuta.
...
B) Combinar Aurora com observabilidade e automacao.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Dimensionar com base no uso real e aproveitar DynamoDB quando fizer sentido.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Treinar questoes focadas em backups e read replicas com explicacao de trade-offs.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
