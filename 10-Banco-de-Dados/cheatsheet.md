...
- **RDS**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **Aurora**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
