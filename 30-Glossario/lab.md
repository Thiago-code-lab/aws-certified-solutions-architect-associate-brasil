...
Montar um fluxo minimo funcional que demonstre **Termos recorrentes de arquitetura AWS**, com validacao clara de comportamento e custo controlado para ambiente de estudo.

## Servicos usados

Termos AWS, Alta disponibilidade, Escalabilidade.
