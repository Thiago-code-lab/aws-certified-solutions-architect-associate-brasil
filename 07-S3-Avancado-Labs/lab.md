...
Montar um fluxo minimo funcional que demonstre **Laboratorio de seguranca e lifecycle em S3**, com validacao clara de comportamento e custo controlado para ambiente de estudo.
