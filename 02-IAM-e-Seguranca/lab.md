...
Montar um fluxo minimo funcional que demonstre **Controle de acesso, identidade e seguranca em camadas**, com validacao clara de comportamento e custo controlado para ambiente de estudo.

## Servicos usados

IAM, KMS, CloudTrail, Organizations.
