...
Montar um fluxo minimo funcional que demonstre **Resiliencia, failover e elasticidade de arquitetura**, com validacao clara de comportamento e custo controlado para ambiente de estudo.

## Servicos usados

Auto Scaling, ELB, Route 53, Multi-AZ.
