...
- **Auto Scaling**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **ELB**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
