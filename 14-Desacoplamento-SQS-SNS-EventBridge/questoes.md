...
Um cenario exige decisao correta em Desacoplamento. Qual abordagem e mais aderente?

A) Aplicar solucao generica sem considerar SQS.
B) Usar SQS com configuracao orientada ao requisito e operacao enxuta.
...
**Explicação:**
A alternativa B cobre o objetivo tecnico de desacoplamento com melhor equilibrio entre requisito, risco e operacao.
...
B) Combinar SNS com observabilidade e automacao.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Dimensionar com base no uso real e aproveitar EventBridge quando fizer sentido.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) A que ignora sinais de DLQ e dependencias da arquitetura.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Treinar questoes focadas em FIFO e idempotencia com explicacao de trade-offs.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
