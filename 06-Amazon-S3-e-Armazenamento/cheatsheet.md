...
- **S3**: priorize quando o cenario precisa de integracao nativa e menor carga operacional.
- **S3 Glacier**: use quando houver necessidade de elasticidade controlada e comportamento previsivel em pico.
