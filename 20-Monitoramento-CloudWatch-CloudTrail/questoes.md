...
Um cenario exige decisao correta em Monitoramento. Qual abordagem e mais aderente?

A) Aplicar solucao generica sem considerar CloudWatch.
B) Usar CloudWatch com configuracao orientada ao requisito e operacao enxuta.
...
**Explicação:**
A alternativa B cobre o objetivo tecnico de monitoramento com melhor equilibrio entre requisito, risco e operacao.
...
B) Combinar CloudTrail com observabilidade e automacao.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Dimensionar com base no uso real e aproveitar alarmes quando fizer sentido.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) A que ignora sinais de logs e dependencias da arquitetura.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
...
B) Treinar questoes focadas em logs e MTTR com explicacao de trade-offs.
C) Adicionar componentes sem necessidade do enunciado.
D) Ignorar requisito explicito de seguranca, disponibilidade ou custo.
